...
$min_prix = mysqli_real_escape_string($db, htmlspecialchars($_POST['prix_min_search']));
$max_prix = mysqli_real_escape_string($db, htmlspecialchars($_POST['prix_max_search']));
...
WHERE plat.Prix BETWEEN '" . $min_prix . "' AND '" . $max_prix . "' GROUP BY plat.ID";