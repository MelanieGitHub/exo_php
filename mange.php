...
<body class="bg-light">
      ...
      <nav class="navbar navbar-expand-xl navbar-light bg-dark">
            <h3 class="text-light logo" title='Final Fantasy 13'>FF XIII | Forum</h3>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                  <ul class="navbar-nav col-12 justify-content-around">
                        ...
                        <li class="nav-item">
                              <a class="nav-link text-light"  onClick="window.location.reload();">
                        ...
                        <li class="nav-item">
                              <a id='lk_Profil' class="nav-link text-light">
                        ...
                        <li class="nav-item">
                              <a href='forum.php?deconnexion=true' class="nav-link text-light">
      ...
      if (!$_SESSION) {
            echo "<div class='text-center mt-5'>
                        ...
                        <a class='text-dark' href='user_login.php'> 
      ...
      <article id='bodyArticle' class='mt-5'>
            ...
            <section id='sctSujets' class='container'>
                  ...
                  <div class='p-4 border rounded bg-smooth-white row'>
                        <h4 class='col-12 border-bottom pb-3 font-weight-bold'>How to make a website ? </h4>

                        <p class='col-sm-8 pt-3'>26/11/2019 | 05:58</p>
                        <p class=' col-sm-4'>
                              <span class='font-weight-bold'>Auteur : </span>
                              <span>Exemple</span>
                        </p>

                        <p class='col-sm-8 font-italic text-secondary'>Lorem ipsum dolor sit amet, consectetur adipisicing elit...</p>
                        <p class='col-sm-4'>28/11/2019 | 12:11</p>
                        <p class='col-sm-8'>
                              <span class='font-weight-bold'>Nombre de messages : </span>
                              <span>12</span>
                        </p>
                        <p class='col-sm-4'>
                              <span class='font-weight-bold'>Nombre de vues : </span>
                              <span>45</span>
                        </p>
                  </div>
